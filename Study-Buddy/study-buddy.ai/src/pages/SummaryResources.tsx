      ...
      <div className="bg-white border-b border-gray-200 sticky top-0 z-10">
        <div className="mobile-container">
          <div className="flex items-center justify-center relative py-4">
            ...
            <h1 className="text-xl font-bold text-gray-900">Summary & Resources</h1>
          </div>
        </div>
      </div>
      ...
      <div className="mobile-container">
        ...
        <div className="py-6">
          ...
          <p className="text-gray-700 leading-relaxed">
            This section covers the key concepts of the topic, including definitions, 
            examples, and applications. It also highlights important formulas and theorems.
          </p>
        </div>
